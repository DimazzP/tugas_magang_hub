...
class AppSize {
  ...
  static double paddingShadowDef = 4;
  ...
  static void initialize(BuildContext context) {
    ...
    sizeLarge = calculatedSize(24);
    sizeExtraLarge = calculatedSize(28);
    sizeSuperLarge = calculatedSize(32);
    ...
    borderSmallBlack = Border.all(color: Colors.black, width: calculatedSize(2));
    borderSmallMediumBlack = Border.all(color: Colors.black, width: calculatedSize(3));
    borderMediumBlack = Border.all(color: Colors.black, width: calculatedSize(4));
  }
